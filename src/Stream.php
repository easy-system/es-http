...
class Stream extends AbstractStream implements StreamInterface
{
     ...
     * Constructor.
     *
     * @param null|false|string|resource $resource Optional;
     *
     * - null by default means "php://temp"
     * - the received "false" means, that resource must not be created
     * - the string as reference to resource as "scheme://target"
     * - the resource to wrap
     * @param string $mode Optional; null by default means "w+b". The type of
     *                     access to the stream if the access type is not
     ...
     *
     * @param string|resource $resource Optional; the string as reference to
     *                                  resource as "scheme://target" or
     *                                  resource to wrap
     * @param type            $mode     Optional; "w+b" by default. The type of
     *                                  access to the stream if the access type
     *                                  is not specified for a resource
     */
    public function attach($resource, $mode = 'w+b')
    {
        $this->setResource($resource, $mode);
    }
     ...
     * - returns a specific key value if a keyis provided and the value is found
